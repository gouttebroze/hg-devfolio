  ...
  return (
    <div className="hero">
      <svg viewBox="0 0 240 80" xmlns="http://www.w3.org/2000/svg">
        <text x="20" y="55" className="small">Hugues, Dév. React</text>
        <text x="40" y="75" className="heavy"></text>
        <text x="55" y="95" className="small">NG/RxJS/NestJS-Java</text>
        <text x="65" y="55" className="Rrrrr">culture DevOps</text>
      </svg>
    </div>
  );
}
